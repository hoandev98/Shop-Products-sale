...
"SELECT chitiethoadon.MaHD, sanpham.TenSP,chitiethoadon.SoLuong, chitiethoadon.DonGia, hoadon.NgayLap 
FROM ((chitiethoadon 
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="index.php" class="navbar-brand d-none d-sm-inline-block">
                  <div class="brand-text d-none d-lg-inline-block"><img src="/shop/public/images/menu/logo/1.jpg"></div>
                          ...
                          <?php 
                            ...
                            while($res = mysqli_fetch_array($result)) { 		
                              ...
                              <form method="post">
                                ...
                                <td>
                                  <button type="submit" name="delete" class="btn btn-danger" id="'.$res["MaHD"].'"><i class="fa fa-trash"></i></button>
                                </td>
                                </form>
                              </tr>
                              ';
