                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                   <a  style="color: black; float: right;" class="my-account" href="./view/login-register.php">My Account</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-content">
                        <div id="li-new-product" class="tab-pane active show" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="li-countdown product-sale-countdown countdown"></div>
                                <div class="product-active owl-carousel">
                                    <div class="col-lg-12">
                                        <!-- single-product-wrap start -->
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="./view/single-product-sale.php">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="./view/single-product-sale.php">Iphone 11 Pro-Max Hot!!!</a></h4>
                                                    <div class="price-box">
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        ...
                                                        <li><a class="links-details" href="./view/wishlist.php"><i class="fa fa-heart-o"></i></a></li>
                                                        <li><a href="#" title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#iphoneModalCenter"><i class="fa fa-eye"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="./view/shop.php">Studio Design</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="./view/single-product-sale.php">Mug Today is a good day</a></h4>
                                                    <div class="price-box">
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="./view/shop.php">Graphic Corner</a>
                                                        </h5>
                                                        <div class="rating-box">
                                                            <ul class="rating">
                                                                <li><i class="fa fa-star-o"></i></li>
                                                    ...
                                                    <h4><a class="product_name" href="./view/single-product-sale.php">Accusantium dolorem1</a></h4>
                                                    <div class="price-box">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="./view/single-product.php">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="./view/single-product.php">Mug Today is a good day</a></h4>
                                                    <div class="price-box">
                                                        <span class="new-price new-price-2">$71.80</span>
                                                        <span class="old-price">$77.22</span>
                                                        <span class="discount-percentage">-7%</span>
